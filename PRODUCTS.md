...
| Bus GX / Bus UI | TSX/React-style UI development for Go and Go/WASM teams, with deterministic rendering, reusable components, portal-ready UI primitives, and testable frontend surfaces. | `bus-gx`, `bus-ui` |
