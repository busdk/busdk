...
IMAGE=${BUS_H100_SMOKE_IMAGE:-bus-integration-task:h100-smoke}
PLATFORM=${BUS_H100_SMOKE_PLATFORM:-linux/amd64}
GO_VERSION=${BUS_H100_SMOKE_GO_VERSION:-1.26.5}
...
SUBMODULES=${BUS_H100_SMOKE_SUBMODULES:-"bus bus-agent bus-api-provider-auth bus-api-provider-events bus-dev bus-events bus-help bus-integration bus-integration-task bus-integration-docker bus-integration-containers bus-integration-ssh-runner bus-lint bus-notes bus-operator-token bus-preferences bus-remote bus-secrets bus-update"}
