...
HUMAN_LABOR_BASE_PER_DAY_EUR="${HUMAN_LABOR_BASE_PER_DAY_EUR:-250}"
HUMAN_LABOR_MODULE_BASE_EUR="${HUMAN_LABOR_MODULE_BASE_EUR:-0}"
HUMAN_LABOR_IMPL_PER_COMMIT_EUR="${HUMAN_LABOR_IMPL_PER_COMMIT_EUR:-3.6}"
HUMAN_LABOR_REVIEW_PER_COMMIT_EUR="${HUMAN_LABOR_REVIEW_PER_COMMIT_EUR:-3.3}"
HUMAN_LABOR_UPKEEP_PER_COMMIT_EUR="${HUMAN_LABOR_UPKEEP_PER_COMMIT_EUR:-3.1}"
PYTHON_BIN="python3"
