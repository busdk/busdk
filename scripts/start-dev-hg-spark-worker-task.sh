...
using gpt-5.3-codex-spark. The worker gets a task worktree and implementation
branch. The prompt should ask only for implementation plus unit tests; do not
ask for e2e or integration tests here.
...
MODEL=${BUS_DEV_HG_SPARK_START_MODEL:-gpt-5.3-codex-spark}
PROFILE=${BUS_DEV_HG_SPARK_START_PROFILE:-codex-spark}
