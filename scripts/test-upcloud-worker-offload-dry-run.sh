...
CONTROLLER_EVENTS_URL=${BUS_UPCLOUD_OFFLOAD_CONTROLLER_EVENTS_URL:-http://$BUS_TEST_HOST:18086}
WORKER_EVENTS_URL=${BUS_UPCLOUD_OFFLOAD_WORKER_EVENTS_URL:-http://bus-events:8081}
WORKER_IMAGE=${BUS_UPCLOUD_OFFLOAD_WORKER_IMAGE:-bus-integration-task:local-image-smoke}
