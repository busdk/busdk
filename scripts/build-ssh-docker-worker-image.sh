...
GO_VERSION=${BUS_SSH_DOCKER_BUILD_GO_VERSION:-1.26.5}
CODEX_VERSION=${BUS_SSH_DOCKER_BUILD_CODEX_VERSION:-0.135.0}
CODEX_NPM_PACKAGE=${BUS_SSH_DOCKER_BUILD_CODEX_NPM_PACKAGE:-@openai/codex}
CODEX_NPM_VERSION=${BUS_SSH_DOCKER_BUILD_CODEX_NPM_VERSION:-}
CODEX_LINUX_AMD64_SHA256=${BUS_SSH_DOCKER_BUILD_CODEX_LINUX_AMD64_SHA256:-a15e7dad657da4a0e120eede29556fee6d50e8c919759cc2ecba3c99099363e2}
CODEX_LINUX_ARM64_SHA256=${BUS_SSH_DOCKER_BUILD_CODEX_LINUX_ARM64_SHA256:-568bce1d593ef25ffdf5549369a8606085652294646a5c4961547a894ea2f76d}
...
docker build \
	...
	--build-arg "CODEX_LINUX_AMD64_SHA256=$CODEX_LINUX_AMD64_SHA256" \
	--build-arg "CODEX_LINUX_ARM64_SHA256=$CODEX_LINUX_ARM64_SHA256" \
	-t "$IMAGE" \
